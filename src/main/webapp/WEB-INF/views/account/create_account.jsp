...
function execPostCode() {
     new daum.Postcode({
         ...
         /*      var a = console.log(data.zonecode);
            ...
            $("[name=postalCode]").val(data.zonecode);
            $("[name=roadNameAddr]").val(fullRoadAddr);
...
<body>
	<article class="container">
		...
		<div class="col-sm-6 col-md-offset-3">
			<form action="register" method="post" role="form" id="usercheck"
				name="member">
				...
				<div class="form-group">
					<label for="mem_pw">비밀번호</label> <input type="password"
						class="form-control" id="mem_pw" name="password"
						placeholder="비밀번호">
					<div class="eheck_font" id="pw_check"></div>
				</div>
				<div class="form-group">
					<label for="mem_pw2">비밀번호 확인</label> <input type="password"
						class="form-control" id="mem_pw2" name="password2"
						placeholder="비밀번호 확인">
				...
				<div class="form-group">
					<label for="mem_name">이름</label> <input type="text"
						class="form-control" id="mem_name" name="name" placeholder="이름">
					<div class="eheck_font" id="name_check"></div>
				</div>

				<div class="form-group">
					<label for="mem_birth">생년월일</label> <input type="tel"
						class="form-control" id="mem_birth" name="birth"
				...
				<div class="form-group">
					<label for="mem_email">이메일 주소</label> <input type="email"
						class="form-control" id="mem_email" name="eMail"
						placeholder="이메일 주소">
					<div class="eheck_font" id="email_check"></div>
				</div>

				<div class="form-group">
					<label for="mem_phone">연락처('-'없이 번호만 입력해주세요)</label> <input
						type="tel" class="form-control" id="mem_phone" name="tel"
						placeholder="휴대폰 번호">
				...
				<div class="form-group">
					<label for="mem_gender">성별</label> <input type="checkbox"
						id="mem_gender" name="gender" value="1">남 <input
						type="checkbox" id="mem_gender" name="gender" value="2">여
				</div>

				<div class="form-group">
					<input class="form-control" style="width: 40%; display: inline;"
						placeholder="우편번호" name="postalCode" id="mem_oaddress" type="text"
						readonly="readonly">
				...
				<div class="form-group">
					<input class="form-control" style="top: 5px;" placeholder="도로명 주소"
						name="roadNameAddr" id="mem_address" type="text" readonly="readonly" />
				</div>

				<div class="form-group">
					<input class="form-control" placeholder="상세 주소" name="detailedAddr"
